    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        if (!(sender instanceof Player)) {
            ...
            if (cmd.getName().equalsIgnoreCase("nc") && args.length != 0) {
                ...
                player.spigot().sendMessage(new ComponentBuilder("(( ").color(ChatColor.YELLOW).append("underline").underlined(true).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/nc underline-")).append("   ").color(ChatColor.RESET).append("underline-bold").underlined(true).bold(true).color(ChatColor.BOLD).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/nc underline-bold-")).append(" ))").color(ChatColor.RESET).color(ChatColor.YELLOW).create());
                player.spigot().sendMessage(new ComponentBuilder("(( ").color(ChatColor.YELLOW).append("strike").strikethrough(true).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/nc strike-")).append("   ").color(ChatColor.RESET).append("strike-bold").color(ChatColor.STRIKETHROUGH).color(ChatColor.BOLD).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/nc strike-bold-")).append(" ))").color(ChatColor.RESET).color(ChatColor.YELLOW).create());
                player.spigot().sendMessage(new ComponentBuilder("(( ").color(ChatColor.YELLOW).append("bold").bold(true).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/nc bold-")).append("   ").color(ChatColor.RESET).append("italic").italic(true).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/nc italic-")).append("   ").color(ChatColor.RESET).append("italic-bold").italic(true).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/nc italic-bold-")).append(" ))").color(ChatColor.RESET).color(ChatColor.YELLOW).create());
